...
function title() {
console.log(chalk.bold.green(figlet.textSync('Kyaa Bot', {
font: 'Standard',
...
browser: ['Kyaa Multi Device','Safari','1.0.0'],
auth: state
})
